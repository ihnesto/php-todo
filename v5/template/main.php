            ...
            <div class="col-md-8 offset-md-2">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex">
                        ...
                        <span>
                            <a class="btn btn-success mr-1" href="index.php?action=edit-task&id=<?= $task['id'] ?>">Edit</a>
                            <a class="btn btn-danger" href="index.php?action=remove-task&id=<?= $task['id'] ?>">Remove</a>
                        </span>
                    </li>
                    <?php 
                        }
